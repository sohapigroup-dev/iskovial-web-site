                  ...
                  {filteredProperties.map((property) => (
                    <div key={property.id} className="border rounded-lg p-3 space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
                        ...
                        <div><span className="font-medium">Surface:</span> {property.surface} m²</div>
                        <div className="col-span-2"><span className="font-medium">Lieu:</span> {property.location}</div>
                      </div>
                      <div className="flex items-center justify-between pt-2 border-t">
                        <span className="font-bold text-primary text-sm">{property.price.toLocaleString()} FCFA</span>
